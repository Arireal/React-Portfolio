...
const Experience = ({ darkMode }) => {
  const jobs = [
    {
      role: 'Lead UX/UI Analyst and Frontend Developer',
    ...
    {
      role: 'Junior UX/UI Web Developer',
      
      period: '2019 - 2021',
      description: 'Assisted in web development projects, improved website responsiveness, and contributed to UI/UX research.'
    }
  ];
