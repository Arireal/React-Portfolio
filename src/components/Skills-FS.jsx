    ...
    <section id="skills" className="py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {[
            { title: 'FullStack', skills: ['React', 'MVC', 'TypeScript', 'Tailwind CSS', 'Node.js', 'Python'], icon: <FaCode /> },
            { title: 'Tools', skills: ['Git', 'Webpack', 'Framer', 'Figma', 'Streamlit'], icon: <FaBriefcase /> },
