    ...
    <section className="py-20 md:py-32">
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 mb-10 md:mb-0">
          ...
          <h2 className="text-2xl md:text-3xl mb-6">Full Stack UX/UI Developer</h2>
          <p className="text-lg mb-8 leading-relaxed max-w-xl">
          I develop full-stack web applications with a focus on React and Node.js, delivering seamless, end-to-end solutions.
          </p>
